...
export const FORM_STEPS: FormStep[] = [
  {
    ...
    questions: [
      ...
      { id: "contact_email", label: "Your email (so we can reach you)", type: "email", required: true },
      { id: "contact_phone", label: "Your phone number", type: "tel" },
      { id: "business_hours", label: "Business hours", type: "textarea" },
      { id: "contact_method", label: "Preferred customer contact method (select all that apply)", type: "checkbox", options: ["Phone call", "Text message", "Email", "Contact form"] },
...
export const QUICK_STEPS: FormStep[] = [
  {
    ...
    questions: [
      ...
      { id: "contact_method", label: "How do you prefer customers to reach you? (select all that apply)", type: "checkbox", options: ["Phone call", "Text message", "Email", "Contact form"] },
      { id: "domain_owned", label: "Do you already own your domain name?", type: "radio", options: ["Yes", "No", "Not sure"] },
      { id: "domain_name", label: "If yes, what is your domain name?", type: "text", placeholder: "yourbusiness.com" },
      { id: "dns_provider", label: "Who manages your domain/DNS?", type: "dns-selector" },
    ],
  },
  {
    ...
    questions: [
      ...
      { id: "standard_pages", label: "What pages do you need?", type: "checkbox", options: ["Home", "About", "Services", "Individual service pages", "Contact", "FAQ", "Blog", "Gallery", "Testimonials", "Financing", "Careers", "Team", "Resources", "Privacy Policy", "Terms and Conditions"] },
      { id: "why_building", label: "Why are you building or redesigning your website right now?", type: "textarea" },
